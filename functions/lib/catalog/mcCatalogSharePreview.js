...
const BOT_RE = /bot|crawl|spider|slurp|facebookexternalhit|Facebot|Twitterbot|LinkedInBot|WhatsApp|TelegramBot|Discordbot|SkypeUriPreview|Slackbot|Pinterest|Googlebot|bingbot|Applebot|Embed/i;
...
export const mcCatalogSharePreview = onRequest({ invoker: 'public' }, async (req, res) => {
    ...
    const description = descRaw.slice(0, 180) ||
        `${productName} en ${nombreTienda}${priceLabel}. Comprá en línea.`;
    const image = (typeof prod.imageUrl === 'string' && prod.imageUrl) ||
