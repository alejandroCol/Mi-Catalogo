...
const METODOS = ['efectivo', 'nequi', 'transferencia', 'credito'];
...
async function deletePreviousDemoSeed(tenantId) {
    const collections = ['pos_sedes', 'pos_productos', 'pos_stock', 'pos_ventas', 'pos_caja_diaria'];
