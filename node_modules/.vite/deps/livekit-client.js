...
var PacketTrailerManager = FrameMetadataManager;
	...
	constructor(options) {
		...
		*/
		...
		this.on(EngineEvent.Closing, () => {
			var _a, _b;
			(_b = (_a = this.bufferStatusLowClosingFuture).reject) === null || _b === void 0 || _b.call(_a, new UnexpectedConnectionState("engine closed"));
		});
				...
				if (dc) {
					if (!_this3.isBufferStatusLow(kind)) switch (bufferStatusLowBehavior) {
						...
						case "drop":
							...
							if (_this3.lossyDataDropCount % 100 === 0) _this3.log.warn("dropping lossy data channel messages, total dropped: ".concat(_this3.lossyDataDropCount));
							return;
					}
	...
	**/
	openSubscriptionStream(sid, signal) {
		...
		const onAbort = () => {
			...
			if ((currentDescriptor === null || currentDescriptor === void 0 ? void 0 : currentDescriptor.subscription.type) === "active") currentDescriptor.subscription.streamControllers.delete(streamController);
	...
	*/
	resendSubscriptionUpdates() {
		for (const _ref11 of this.descriptors) {
			...
			const sid = _ref12[0];
			if (_ref12[1].subscription.type === "none") continue;
			this.emit("sfuUpdateSubscription", {
				sid,
				subscribe: true
			});
	...
	performRpc(_a) {
		return __awaiter(this, arguments, void 0, function(_ref) {
			...
			return function* () {
				...
				const minEffectiveTimeoutMs = maxRoundTripLatencyMs + 1e3;
...
var Room = class Room extends eventsExports.EventEmitter {
		...
		*/
		...
		this.connectSignal = (url, token, engine, connectOptions, roomOptions, abortController) => __awaiter(this, void 0, void 0, function* () {
			...
			const _yield$engine$join = yield engine.join(url, token, {
				...
				clientInfoCapabilities: isFrameMetadataSupported((_a = roomOptions.frameMetadata) !== null && _a !== void 0 ? _a : roomOptions.packetTrailer) || !!this.e2eeManager ? [ClientInfo_Capability.CAP_PACKET_TRAILER] : void 0,
	...
	*/
	...
	setupFrameMetadata() {
		var _a;
		this.frameMetadataManager = new FrameMetadataManager((_a = this.options.frameMetadata) !== null && _a !== void 0 ? _a : this.options.packetTrailer);
...
var TokenSourceSandboxTokenServer = class extends TokenSourceEndpoint {
	constructor(sandboxId, options) {
		const _options$baseUrl = options.baseUrl, baseUrl = _options$baseUrl === void 0 ? "https://cloud-api.livekit.io" : _options$baseUrl, rest = __rest(options, ["baseUrl"]);
...
function facingModeFromDeviceLabel(deviceLabel) {
	...
	return (_a = Array.from(knownDeviceLabelSections.entries()).find((_ref) => {
		let section = _slicedToArray(_ref, 1)[0];
