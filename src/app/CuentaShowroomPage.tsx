...
export function CuentaShowroomPage() {
  ...
  const [teaserEyebrow, setTeaserEyebrow] = useState(SHOWROOM_DEFAULTS.teaserEyebrow)
  const [teaserHeadline, setTeaserHeadline] = useState(SHOWROOM_DEFAULTS.teaserHeadline)
  const [teaserSubheadline, setTeaserSubheadline] = useState(SHOWROOM_DEFAULTS.teaserSubheadline)
  const [teaserCtaLabel, setTeaserCtaLabel] = useState(SHOWROOM_DEFAULTS.teaserCtaLabel)
  const [collectionTitle, setCollectionTitle] = useState(SHOWROOM_DEFAULTS.collectionTitle)
  const [collectionSubtitle, setCollectionSubtitle] = useState(SHOWROOM_DEFAULTS.collectionSubtitle)
  const [homeEyebrow, setHomeEyebrow] = useState(SHOWROOM_DEFAULTS.homeEyebrow)
  const [homeHeadline, setHomeHeadline] = useState(SHOWROOM_DEFAULTS.homeHeadline)
  const [homeSubheadline, setHomeSubheadline] = useState(SHOWROOM_DEFAULTS.homeSubheadline)
  const [homeCtaLabel, setHomeCtaLabel] = useState(SHOWROOM_DEFAULTS.homeCtaLabel)
  ...
  const [homeFullWidth, setHomeFullWidth] = useState(SHOWROOM_DEFAULTS.homeFullWidth)
  const [atelierHeadline, setAtelierHeadline] = useState(SHOWROOM_DEFAULTS.atelierHeadline)
  const [atelierSubheadline, setAtelierSubheadline] = useState(SHOWROOM_DEFAULTS.atelierSubheadline)
