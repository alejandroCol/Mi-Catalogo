...
export function buildProductoPayloadFromQuickAddForm(
  ...
  return {
    ...
    ...(esConTallas && stockPayload
      ...
      : {}),
    marcarNovedad: form.marcarNovedad,
    mostrarDescargaImagen: form.mostrarDescargaImagen,
    mostrarBotonDocena: form.mostrarBotonDocena,
    mostrarStockCatalogo: form.mostrarStockCatalogo,
