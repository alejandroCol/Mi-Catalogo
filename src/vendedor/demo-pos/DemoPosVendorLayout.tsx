...
import { DemoPosVendorShell } from '@/vendedor/demo-pos/DemoPosVendorShell'

export function DemoPosVendorLayout() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-svh flex-col items-center justify-center gap-3 bg-[#f6f5f2]">
        ...
        <p className="text-sm text-neutral-600">Cargando demo POS cajera…</p>
      </div>
    )
  }
